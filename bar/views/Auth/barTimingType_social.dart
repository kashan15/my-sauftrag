...
class BarTimingAndTypeSocial extends StatefulWidget {
  const BarTimingAndTypeSocial({Key? key}) : super(key: key);

  @override
  _BarTimingAndTypeSocialState createState() => _BarTimingAndTypeSocialState();
}

class _BarTimingAndTypeSocialState extends State<BarTimingAndTypeSocial> {
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              ...
                              model.notifyListeners();
                              // model.createAccount();
                              model.createAccountOne(context);
