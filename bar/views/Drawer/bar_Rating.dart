...
class _BarRatingState extends State<BarRating> with SingleTickerProviderStateMixin {
                  ...
                  child: Center(
                    child: Container(
                      ...
                      child: PhotoViewGallery.builder(
                        itemCount: model.selectedBar!.catalogue_image1!.length,
                        pageController: pageController,
                        builder: (context, index) {
                          return  PhotoViewGalleryPageOptions(
                            imageProvider: NetworkImage(model.selectedBar!.catalogue_image1![index]),
