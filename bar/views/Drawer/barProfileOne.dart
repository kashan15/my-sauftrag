...
import 'package:sauftrag/services/admin_service.dart';
...
class Barprofileone extends StatefulWidget {

  //int? index;

  Barprofileone({Key? key}) : super(key: key);

  @override
  _BarprofileoneState createState() => _BarprofileoneState();
}

class _BarprofileoneState extends State<Barprofileone> with SingleTickerProviderStateMixin{
                        ...
                        Positioned(
                            ...
                            child: Container(
                                ...
                                child: ClipRRect(
                                    ...
                                    child: model.selectedBar!.profile_picture == null ?
                                    SvgPicture.asset(ImageUtils.logo,
                                      width: 20.i,
                                      height: 20.i,
                                      fit: BoxFit.fill,)
                                    : Image.network(model.selectedBar!.profile_picture!,fit: BoxFit.fill,
                                    ))))
                      ],
                    ),
                  ),
                      ...
                      child: Column(
                        children: [
                              ...
                              GestureDetector(
                                onTap: ()async{
                                  ...
                                  if (request is String){
                                    ...
                                    if (!request){
                                      model.listOfAllBars.removeWhere((element)=>model.selectedBar!.id==element.id);
                                      model.selectedBar!.is_active = request;
                                      if (model.listOfAllBarsRequest.isNotEmpty){
                                        model.listOfAllBarsRequest.insert(0,model.selectedBar!);
                                      }
                                      else {
                                        model.listOfAllBarsRequest.add(model.selectedBar!);
                                      }
                                      model.navigateBack();
                                    }
                                    else{
                                      model.listOfAllBarsRequest.removeWhere((element)=>model.selectedBar!.id==element.id);
                                      model.selectedBar!.is_active = request;
                          ...
                          Align(
                            ...
                            child: model.selectedBar!.about == null ?
                                Text("sauftrag",
                                  style: TextStyle(
