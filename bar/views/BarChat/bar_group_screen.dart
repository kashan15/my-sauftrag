...
class _BarGroupScreenState extends State<BarGroupScreen> with SingleTickerProviderStateMixin {
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                   widget.userLength!.toString() +
                                                       // " Members" ,
                                                       AppLocalizations.of(context)!
                                                           .translate('grp_msg_screen_text_3')!,
                                                    style: TextStyle(
                                                        fontFamily:
                                                        FontUtils.modernistBold,
                                                        fontSize: 1.5.t,
                                ...
                                children: [
                                                          ...
                                                          child: Container(
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Text(
                                                                // "Recording....." ,
                                                                AppLocalizations.of(context)!
                                                                    .translate('grp_msg_screen_text_2')!,
                                                                style: TextStyle(
                                                                    fontSize: 2.2.t,
                                                            ...
                                                            TextField(
                                                              ...
                                                              decoration: InputDecoration(
                                                                ...
                                                                // "Type your message...",
                                                                AppLocalizations.of(context)!
                                                                    .translate('grp_msg_screen_text_1')!,
                                                                hintStyle: TextStyle(
                                                                  //fontFamily: FontUtils.proximaNovaRegular,
                                                                  //color: ColorUtils.silverColor,
                                                                  fontSize: SizeConfig
                                  ...
                                  InkWell(
                                    onTap: () async {
                                      ...
                                      await model.pubnub!.publish(widget.username!, {
                                          ...
                                          Positioned.fill(
                                              child: Material(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: (){
                                                    model.sendFileMessageGroupBar(widget.id!, widget.username!);
                                                  },
                                                ),
                                              )
                                          )
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        //fontFamily: FontUtils.avertaDemoRegular,
                          fontSize: 1.5.t,
                          color: model.chats[widget.index!]["userID"] ==
                              model.barModel!.id!?ColorUtils.white:ColorUtils.icon_color),
                    ),
                  ),
                ),
              ],
