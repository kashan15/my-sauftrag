...
class ProfieMatch extends StatefulWidget {
  dynamic index;
  dynamic data;
  UserModel user;
  bool fromProfie;
  ...
  @override
  _ProfieMatchState createState() => _ProfieMatchState();
}

class _ProfieMatchState extends State<ProfieMatch> {
