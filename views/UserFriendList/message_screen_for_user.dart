...
class MessageScreenForUser extends StatefulWidget {
  ...
  MessageScreenForUser({Key? key, this.id, this.username, this.profilePic, this.fromUser,this.user,this.email})
      : super(key: key);
                                                                  ...
                                                                  child: Container(
                                                                    ...
                                                                    TextField(
                                                                      ...
                                                                      decoration: InputDecoration(
                                                                        ...
                                                                        // "User is blocked"
                                                                        AppLocalizations.of(context)!
                                                                            .translate('user_msg_scr_text_4b')!
                                                                            :
                                                                        jsonDecode(model.channelMetaDataDetails!.custom!["block"])[model.userModel!.id.toString()]
                                                                            ?
                                                                        // "you have been blocked"
                                                                        AppLocalizations.of(context)!
                                                                            .translate('user_msg_scr_text_4c')!
                                                                            :
                                                                        // "Type your message..."
                                                                        AppLocalizations.of(context)!
                                                                            .translate('user_msg_scr_text_4')!
                                                                            :
                                                                        // "Type your message...",
                                                                        AppLocalizations.of(context)!
                                                                            .translate('user_msg_scr_text_4a')!,
                                                                        hintStyle: TextStyle(
                                              ...
                                              onTap: () {
                                                ...
                                                showDialog(
                                                    ...
                                                    builder:
                                                      ...
                                                      return ReportChatDialogBox(name: widget.username!,email: widget.email!,user : widget.user!.role==1?"User":"Bar",id: widget.user!.id.toString(),);
                                                    });
                                              },
                                              child: Container(
                                          ...
                                          child: InkWell(
                                            ...
                                            child: Container(
                                              ...
                                              Text(
                                                // "Unblock",
                                                AppLocalizations.of(context)!
                                                    .translate('user_msg_scr_text_3b')!,
                                                style: TextStyle(
                                                    fontFamily:
                                                    FontUtils.modernistRegular,
                                                    fontSize: 1.9.t,
