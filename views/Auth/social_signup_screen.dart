  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<RegistrationViewModel>.reactive(
      builder: (context, model, child) {
        ...
        // model.signUpBarEmailController.text = model.email;
        // model.signUpBarUserController.text = model.displayName!;
        //
        // model.signUpUserController.text = model.displayName!;
        // model.signUpEmailController.text = model.email;
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: TextField(
                                          ...
                                          //controller: TextEditingController(text: '${model.displayName!}'),
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: TextField(
                                          ...
                                          // controller: model.signUpEmailController.(emailController),
      ...
      onModelReady: (model) =>
      {
        ...
        if(model.email == ""){
          ...
          model.notifyListeners(),
          model.signUpEmailController.text = model.userEmail,
        }
        else{
          model.signUpEmailController.clear(),
          model.notifyListeners(),
        ...
        if(model.email == ""){
          ...
          model.notifyListeners(),
          model.signUpBarEmailController.text = model.userEmail,
        }
        else{
          model.signUpBarEmailController.clear(),
          model.notifyListeners(),
