...
class DashboardExpandBar extends StatefulWidget {
  const DashboardExpandBar({Key? key}) : super(key: key);

  @override
  _DashboardExpandBarState createState() => _DashboardExpandBarState();
}

class _DashboardExpandBarState extends State<DashboardExpandBar> {
  @override
