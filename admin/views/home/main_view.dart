...
import '../../../widgets/my_side_menu_admin.dart';

class MainViewAdmin extends StatefulWidget {
  int index;
  MainViewAdmin({Key? key, required this.index}) : super(key: key);
                                          ...
                                          children: [
                                            Expanded(
                                              child: GestureDetector(
                                                onTap: () {
                                                  // model.getAllUserForChat();
                                                  model
                                                      .navigateToDashboardExpandUserScreen();
                                                },
                                                child: Container(
                                            ...
                                            Expanded(
                                              child: GestureDetector(
                                                onTap: () {
                                                  model
                                                      .navigateToDashboardExpandScreen();
                                                },
                                                child: Container(
                                                  decoration: BoxDecoration(
                                                    color: ColorUtils
