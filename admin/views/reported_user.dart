...
class ReportedUser extends StatefulWidget {
  dynamic index;
  int? id;
  // List<String> images;
  // String? name;
  ...
  @override
  _ReportedUserState createState() => _ReportedUserState();
}

class _ReportedUserState extends State<ReportedUser> with WidgetsBindingObserver {
  @override
  void initState() {
    super.initState();
                                        ...
                                        children: [
                                          GestureDetector(
                                            onTap: ()async{
                                              ...
                                              var request = await AdminService().changeUserStatus(model.matchedUser!.id.toString(), model.matchedUser!.is_active !=null ? !model.matchedUser!.is_active! :true);
                                              if (request is String){
                                                ...
                                                if(!request){
                                                  model.matchedUser!.is_active = null;
                                                }
                                                else{
                                                  model.matchedUser!.is_active = request;
                                                }
                                              }
                                              model.notifyListeners();
                                            ...
                                            child: Container(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Center(
                                                    // child: model.matchedUser!.is_follow == null?
                                                      child: model.matchedUser!.is_active!=null && model.matchedUser!.is_active!?
                                          ...
                                          GestureDetector(
                                            onTap: ()async{
                                              ...
                                              var request = await AdminService().warnUser(model.selectedReport!.user_id!.id.toString());
                                              if (request is String){
                                                await DialogUtils().showDialog(MyErrorWidget(
                                                    error: request));
                                              }
