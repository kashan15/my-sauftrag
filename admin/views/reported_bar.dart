...
class ReportedBar extends StatefulWidget {

  //int? index;

  ReportedBar({Key? key}) : super(key: key);

  @override
  _ReportedBarState createState() => _ReportedBarState();
}

class _ReportedBarState extends State<ReportedBar> with SingleTickerProviderStateMixin{
                                ...
                                children: [
                                  GestureDetector(
                                    onTap: ()async{
                                      ...
                                      var request = await AdminService().changeUserStatus(model.selectedBar!.id.toString(), !model.selectedBar!.is_active!);
                                        ...
                                        child: Padding(
                                          ...
                                          child: Center(
                                            // child: model.matchedUser!.is_follow == null?
                                              child: model.selectedBar!.is_active!?
