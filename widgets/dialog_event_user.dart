...
class DialogEventUser extends StatefulWidget {

  String title;
  String btnTxt;
  String icon;

  DialogEventUser({Key? key, required this.title, required this.btnTxt, required this.icon}) : super(key: key);

  @override
  _DialogEventUserState createState() => _DialogEventUserState();
}

class _DialogEventUserState extends State<DialogEventUser> {
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  alignment: Alignment.center,
                  child: Text(
                    // "Please Insert Atleast One Image",
                    AppLocalizations.of(
                        context)!
                        .translate('user_dialog_text_2')!,
                    textAlign: TextAlign.center,
                    style: TextStyle(
